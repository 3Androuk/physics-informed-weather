...
FNO vs AFNO baseline comparison on ERA5 Z500, T850, U850, V850 using
[WeatherBench 2](https://sites.research.google/weatherbench/) data at 1.5-degree
resolution (120 x 240 grid), with zero-shot inference at 0.25-degree (720 x 1440).
...
- Variables: geopotential @ 500 hPa (Z500), temperature @ 850 hPa (T850), u-wind @ 850 hPa (U850), v-wind @ 850 hPa (V850)
